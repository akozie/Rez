...
class BookingPagingAdapter(private val onBookingClickListener: OnBookingClickListener): PagingDataAdapter<Booking, BookingPagingAdapter.BookingMyViewHolder>(differCallback)  {
                ...
                holder.itemView.apply {
                    with(holder){
                        if (current?.table?.table_image_url != null){
                            ...
                            timeTv.text = current?.booked_for?.substring(10)
